...
<body>
 ...
 <div class="container theme-showcase" role="main">
	 ...
	 <div class="jumbotron" align="center">
	   <h3>关于说明</h3>
	   <p align="left">系统介绍:此为会议室预定小系统,主要使用SpringMVC框架,数据库使用原始JDBC方式,前端采用bootstrap框架,涉及到简单的CURD</p>
	   <p align="left">编写目的:为熟悉Spring、bootstrap框架技术,纯属个人兴趣爱好</p>
	   <p align="left">作者:hehe</p>
